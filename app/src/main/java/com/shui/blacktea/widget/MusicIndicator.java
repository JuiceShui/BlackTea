...
public class MusicIndicator extends LinearLayout {
    public MusicIndicator(Context context) {
        this(context, null);
    }

    public MusicIndicator(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MusicIndicator(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void create(int count) {
        for (int i = 0; i < count; i++) {
            ...
            int padding = DisplayUtils.dip2px(App.getInstance(), 3);
